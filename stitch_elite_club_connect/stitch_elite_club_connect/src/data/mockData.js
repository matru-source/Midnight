...
export const mockTables = [
  { id: 'T1', name: 'Royal VIP Booth 01', zone: 'DJ Stage Front', minSpend: 45000, capacity: 8, status: 'occupied', client: 'Rohan Sharma' },
  { id: 'T2', name: 'Royal VIP Booth 02', zone: 'DJ Stage Front', minSpend: 45000, capacity: 8, status: 'available', client: null },
  { id: 'T3', name: 'Terrace Deck 03', zone: 'Mezzanine Terrace', minSpend: 30000, capacity: 6, status: 'reserved', client: 'Ananya Roy' },
  { id: 'T4', name: 'Terrace Deck 04', zone: 'Mezzanine Terrace', minSpend: 30000, capacity: 6, status: 'available', client: null },
  { id: 'T5', name: 'Emperor Suite 05', zone: 'Private VIP Deck', minSpend: 95000, capacity: 12, status: 'occupied', client: 'Kabir Malhotra' },
  { id: 'T6', name: 'Emperor Suite 06', zone: 'Private VIP Deck', minSpend: 95000, capacity: 12, status: 'available', client: null },
  { id: 'T7', name: 'Dancefloor Pod 07', zone: 'Main Floor', minSpend: 20000, capacity: 4, status: 'available', client: null },
  { id: 'T8', name: 'Dancefloor Pod 08', zone: 'Main Floor', minSpend: 20000, capacity: 4, status: 'reserved', client: 'Priya Patel' }
];

export const mockCocktails = [
  { id: 'm1', name: 'Cardamom Midnight Mule', price: 1250, description: 'Smirnoff Gold, Cardamom infusion, fresh lime, ginger beer & luminous blue curaçao.', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuD22BvkvOfa1s0xqGBa0PGsacO1zwTu8WTOsK32sBTcK7yyNOQll6JpRkSi7_9i3iL46Ai-uI3eszGXR_PNKqxydIDa0Q4K9-sNei_eVovI_VKsGn1JJOb-9ylW2k4RvXuI97zeu8W1UyxZX4n4zMtXoVrm04yG-h71bxRzjZULOfkreduwM-5_wUfI2YFC11YBP9Yes6JhLJ8EW6S0AWb6E_ScDnYRSTZ8JR4hCZpw8JaTperwt7RJaQ' },
  { id: 'm2', name: 'Electric Saffron Martini', price: 1450, description: 'Jaisalmer Indian Craft Gin, dry vermouth, edible 24k gold leaf, Kashmiri saffron dust.', image: null },
  { id: 'm3', name: 'Dom Pérignon Luminous (2012)', price: 45000, description: 'Vintage Champagne with illuminated emblem bottle for VIP celebrations.', image: null },
  { id: 'm4', name: 'Rampur Select Indian Single Malt', price: 28000, description: 'Himalayan handcrafted single malt scotch, smooth caramel and spice notes.', image: null }
];

export const mockFriends = [
  { id: 'f1', name: 'Rohan Sharma', table: 'Royal Booth 01', status: 'Online', avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDtdSiPshQjCtMnKFie1pQ8CCxqhfO6wrBv187u_ATQA7ouJsrGBqbytWl4XvJyCEph1EC6cZjV1PvOX188ruPGl5ridR-cLpKSMrVvTNYn_yt-6DEeiO-SDJTVlK8RV1B1_woXG9KkyJcJRCIVoG8ugcIDd7BlkFr35VA7SMJ_UJgybXAIWcjBfe6bg4wPVQ2v_9bKGMNz0CvT7bk3x6Dhl4U7k-wCEaq4jhsGHVsVaYDeBrxvNswTyg' },
  { id: 'f2', name: 'Ananya Roy', table: 'Guestlist', status: 'En Route', avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuA4fanjAf6KjYp_ekQff7ocopzvYCaJB88Igz9YdKxJxXEZX48nt9vb82hoEDk2MIeLg3beN7WVKWyhIEZ30oW8J95nLoQUZZPrKkdYWaBNgp3MSLSd-lPQtQbi0Z0GCnOIWS1NFy10cFzr_xvuF28JeW170MaBJL-vA1bTs1hIRgAWL-me0_txcZRVInMKWm1Dkp0V7BEfKMnOzgpMSDnWidWKPDqmS-qwoUq4GUoTxRFeEj6NoXqYlg' },
  { id: 'f3', name: 'Kabir Malhotra', table: 'Emperor Suite', status: 'Online', avatar: null }
];

export const initialChatMessages = [
  { id: 1, user: 'Aarav_BKC', color: 'text-primary-fixed', message: 'VIP entry gate at BKC Annex is moving super fast!' },
  { id: 2, user: 'Priya_MUM', color: 'text-secondary', message: 'Who is at the main bar right now? Drink specials live!' },
  { id: 3, user: 'Kabir_VIP', color: 'text-tertiary-fixed-dim', message: 'Nucleya & Anyma set starting in 15 minutes! Wild energy.' }
];
...
export const mockModerationFlags = [
  {
    id: 'm-1',
    type: 'High Priority Report',
    timestamp: '10m ago',
    description: "Multiple reports for unauthorized entry attempt at 'Royal Suite 05'.",
    severity: 'high'
  },
  {
    id: 'm-2',
    type: 'Automated Flag',
    timestamp: '1h ago',
    description: 'Suspicious bulk ticket purchasing detected for Sunburn After-Hours event.',
    severity: 'medium'
  }
];
